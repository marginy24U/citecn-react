        ...
        <div className="lateral d-flex">
            ...
            <aside className={`menu ${!mOpen && "oculto"}`}>
                ...
                <ul className="list-group mx-2">
                    ...
                    <NavLink to='/ingresos' className="p-0 list-group-item position-relative d-flex align-items-center bg-transparent border-0 text-white">
                    ...
                    <NavLink to='/proveedores' className="p-0 list-group-item position-relative d-flex align-items-center bg-transparent border-0 text-white">
                        <i class="fas fa-truck"></i> <span className={`texto ${!mOpen && "oculto"}`}>Proveedores</span>
                    </NavLink>
                </ul>
            </aside>

            <button onClick={abreCierraMenu} className="burguer btn btn-dark text-white align-self-start "><i className="fas fa-bars"></i></button>
        </div>
    ); 
};
