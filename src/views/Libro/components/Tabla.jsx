    ...
    const columnas = [
        {
            ...
            render: rowData => <button onClick={() => {
                setIsEditar(true); setIdLibro(rowData.id_libro); formFill(rowData.titulo, rowData.descripcion, rowData.stock, rowData.minimo, rowData.precio, 
                                                rowData.ubicacion, rowData.id_categoria, rowData.Categoria.nombre)                    
            }}
                className="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#modalAddEL">
        ...
        { title: "Categoria", field: "Categoria.nombre", type: 'numeric', cellStyle: { borderRight: "solid #6c757d 1px", textAlign: "center" } },
    ]
